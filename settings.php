<?php
define('C_REST_CLIENT_ID','local.64612e47178016.84188219');//Application ID
define('C_REST_CLIENT_SECRET','UBkcXpjF0XXl9Z60NNHya53anRVUvVumv9vO0JzNwQ7PMHSsSK');//Application key
// or
